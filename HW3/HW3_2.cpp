        ...
        case 0:
            {
                for(unsigned long long i=0;i<16;i++)
                {
                    if(i%4!=3)
                    {
                        ...
                        {
                            if((Map_element(Map,i>>2,i%4)==Map_element(Map,i/4,i%4+1))||Map_element(Map,i/4,i%4+1)==0)
                                return true;
                        }
                    }
        ...
        case 1:
            {
                for(unsigned long long i=0;i<12;i++)
                {
                    if(Map_element(Map,i>>2,i&3)!=0)
                    {
                        if((Map_element(Map,i>>2,i%4)==Map_element(Map,i/4+1,i%4))||Map_element(Map,i/4+1,i%4)==0)
                            return true;
                    }
                }
                return false;
