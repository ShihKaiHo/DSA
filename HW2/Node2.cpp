...
int main(int argc, char *argv[])
{
    ...
    while(fscanf(fp_2,"%s",buff_c)!=EOF)
    {
        ...
        fscanf(fp_2,"%u",frequency_array_2+i);
        i++;
    }
    t2=clock();
    ...
    unsigned int* frequency_array_3=new unsigned int[15960930];
    while(fscanf(fp_3,"%u",buff_c)!=EOF)
    {
        ...
        fscanf(fp_3,"%u",frequency_array_3+i);
    ...
    unsigned int* frequency_array_4=new unsigned int[11765370];
    ...
    while(fscanf(fp_4,"%s",buff_c)!=EOF)
    {
        ...
        fscanf(fp_4,"%u",frequency_array_4+i);
        i++;
    }
    t2=clock();
    ...
    unsigned int* frequency_array_5=new unsigned int[6003240];
    while(fscanf(fp_5,"%s",buff_c)!=EOF)
    {
        ...
        fscanf(fp_5,"%u",frequency_array_5+i);
        i++;
    }
    t1=clock();
    print((t1-t2)/double(CLOCKS_PER_SEC))
