...
int main(int argc, char *argv[])
{
    ...
    vector<unsigned int> sentence_pos_3(15960930);
    sentence_pos_3[0]=ftell(fp_3);
    ...
    vector<unsigned int> sentence_pos_4(11765370);
    sentence_pos_4[0]=ftell(fp_4);
    ...
    vector<unsigned int> sentence_pos_5(5773240);
    sentence_pos_5[0]=ftell(fp_5);
